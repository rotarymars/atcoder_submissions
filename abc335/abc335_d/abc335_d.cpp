...
int main()
{
  ...
  for (size_t i = 0; i < n * n - 2; i++)
  {
    ...
    {
      noww++;
      grid[nowh][noww] = grid[nowh][noww - 1] + 1;
      if (noww == hwmax || noww == 0)
      {
        mode = (mode + 1) % 4;
      }
      else if (grid[nowh][noww + 1] != 1e9)
      {
        mode = (mode + 1) % 4;
      }
    }
    ...
    {
      nowh++;
      grid[nowh][noww] = grid[nowh - 1][noww] + 1;
      if (nowh == hwmax || nowh == 0)
      {
        mode = (mode + 1) % 4;
      }
      else if (grid[nowh + 1][noww] != 1e9)
      {
        mode = (mode + 1) % 4;
      }
    }
