...
signed main() {
  ...
  double v = (double)dis / 60;

  if (v < 0.25) cout << "C";
  else if (deg >= 113 && deg <= 337) cout << "NNE";
  else if (deg >= 338 && deg <= 562) cout << "NE";
  else if (deg >= 563 && deg <= 787) cout << "ENE";
  else if (deg >= 788 && deg <= 1012) cout << "E";
  else if (deg >= 1013 && deg <= 1237) cout << "ESE";
  else if (deg >= 1238 && deg <= 1462) cout << "SE";
  else if (deg >= 1463 && deg <= 1687) cout << "SSE";
  else if (deg >= 1688 && deg <= 1912) cout << "S";
  else if (deg >= 1913 && deg <= 2137) cout << "SSW";
  else if (deg >= 2138 && deg <= 2362) cout << "SW";
  else if (deg >= 2363 && deg <= 2587) cout << "WSW";
  else if (deg >= 2588 && deg <= 2812) cout << "W";
  else if (deg >= 2813 && deg <= 3037) cout << "WNW";
  else if (deg >= 3038 && deg <= 3262) cout << "NW";
  else if (deg >= 3263 && deg <= 3487) cout << "NNW";
  else cout << "N";

  cout << ' ';

  if (v < 0.25) cout << 0;
  else if (v < 1.55) cout << 1;
  else if (v < 3.35) cout << 2;
  else if (v < 5.45) cout << 3;
  else if (v < 7.95) cout << 4;
  else if (v < 10.75) cout << 5;
  else if (v < 13.85) cout << 6;
  else if (v < 17.15) cout << 7;
  else if (v < 20.75) cout << 8;
  else if (v < 24.45) cout << 9;
  else if (v < 28.45) cout << 10;
  else if (v < 32.65) cout << 11;
  else cout << 12;
  cout << endl;
  return 0;
}
