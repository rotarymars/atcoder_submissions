...
signed main() {
  ...
  long double p = 0;
  // 456
  p += ((long double)count(a.begin(), a.end(), 4) / (long double)6.0) *
       ((long double)count(b.begin(), b.end(), 5) / (long double)6.0) *
       ((long double)count(c.begin(), c.end(), 6) / (long double)6.0);
  p += ((long double)count(a.begin(), a.end(), 4) / (long double)6.0) *
       ((long double)count(b.begin(), b.end(), 6) / (long double)6.0) *
       ((long double)count(c.begin(), c.end(), 5) / (long double)6.0);
  p += ((long double)count(a.begin(), a.end(), 5) / (long double)6.0) *
       ((long double)count(b.begin(), b.end(), 4) / (long double)6.0) *
       ((long double)count(c.begin(), c.end(), 6) / (long double)6.0);
  p += ((long double)count(a.begin(), a.end(), 5) / (long double)6.0) *
       ((long double)count(b.begin(), b.end(), 6) / (long double)6.0) *
       ((long double)count(c.begin(), c.end(), 4) / (long double)6.0);
  p += ((long double)count(a.begin(), a.end(), 6) / (long double)6.0) *
       ((long double)count(b.begin(), b.end(), 4) / (long double)6.0) *
       ((long double)count(c.begin(), c.end(), 5) / (long double)6.0);
  p += ((long double)count(a.begin(), a.end(), 6) / (long double)6.0) *
       ((long double)count(b.begin(), b.end(), 5) / (long double)6.0) *
